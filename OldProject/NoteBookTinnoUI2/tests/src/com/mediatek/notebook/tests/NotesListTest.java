...
import com.mediatek.notebook.NoteDelete;
 ...
 * -e class com.mediatek.notebook.NotesListTest \
 * com.mediatek.notebook.tests/android.test.InstrumentationTestRunner
 */

//build apk:mk -t -o=MTK_AUTO_TEST=yes mm mediatek/source/packages/NoteBook
//install apk:adb install -r out/target/product/athens15v2/data/app/NotebookTests.apk
...
public class NotesListTest extends ActivityInstrumentationTestCase2<NotesList> {
    ...
    public void addNote(int noteCount) {
        ...
        switch (number) {
            ...
            case 1:
                ...
                mSolo.clickOnText(mSolo.getString(R.string.menu_work_ui));
                break;
            case 2:
                mSolo.enterText(0, "New note of personal");
                mSolo.clickOnText(mSolo.getString(R.string.menu_none));
                mSolo.clickOnText(mSolo.getString(R.string.menu_personal_ui));
                break;
            case 3:
                mSolo.enterText(0, "New note of family");
                mSolo.clickOnText(mSolo.getString(R.string.menu_none));
                mSolo.clickOnText(mSolo.getString(R.string.menu_family_ui));
                break;
            case 4:
                mSolo.enterText(0, "New note of study");
                mSolo.clickOnText(mSolo.getString(R.string.menu_none));
                mSolo.clickOnText(mSolo.getString(R.string.menu_study_ui));
                break;
            default:
                break;
            }
    ...
    /*Test the first activity NotesList*/
    ...
    public void test03LongPressAddButton() {
        Log.i(TAG, "test03_LongPressAddButton: begining");
        View view = mActivity.findViewById(R.id.menu_add);
        mSolo.clickLongOnView(view);
        assertTrue(mSolo.searchText(mSolo.getString(R.string.menu_add_button)));
        Log.i(TAG, "test03_LongPressAddButton: ending");
    }
   
    public void test04LongClickNote() {
        ...
        assertTrue(mSolo.searchText(mSolo.getString(R.string.title_notes_list)));
        Log.i(TAG, "test04_LongClickNote: ending");
    }
    
    public void test05MenuSort1() {
    ...
    public void test06MenuSort2() {
        ...
        if (getCurrentNoteNumber() == 0) {
            ...
            ArrayList<ListView> listview = mSolo.getCurrentListViews();
            for (int i = 1; i < getCurrentNoteNumber(); i ++) {
    ...
    /*Test the second activity NoteReading*/
    public void test07ScrollBarInView() {
    ...
    public void test09DeleteCurrentNote() {
     ...
     public void test10CancelDeleteOne() {
         ...
         assertTrue(count == getCurrentNoteNumber());       
     ...
     /*Test the third activity NoteView*/
     ...
     /*Test the 4th activity NoteDelete*/
     public void test15DeleteFirstNote() {
         ...
         mSolo.sleep(mSleeptime);
         mSolo.sendKey(KeyEvent.KEYCODE_DPAD_DOWN);
         mSolo.sendKey(KeyEvent.KEYCODE_DPAD_UP);
         mSolo.sleep(mSleeptime);
         mSolo.sendKey(KeyEvent.KEYCODE_ENTER);
         mSolo.sleep(mSleeptime);
    ...
    public void test16DeleteOddNumberNote() {
        Log.i(TAG, "test16_DeleteOddNumberNote: begining");
        int countBefore = getCurrentNoteNumber();
        if (countBefore == 0) {
            Log.e(TAG, "There is no note in the list");
            addNote(6);
        ...
        mSolo.sleep(mSleeptime);
        for (int i = 1; i < 6; i++) {
            if (i % 2 == 1 && !mSolo.isCheckBoxChecked(i - 1)) {
                mSolo.clickOnCheckBox(i - 1);
            } else if (i % 2 == 0 && mSolo.isCheckBoxChecked(i - 1)) {
                mSolo.clickOnCheckBox(i - 1);
            }
        }
        mSolo.clickOnView(findView(R.id.menu_delete));
        ...
        assertTrue(countBefore - 3 == getCurrentNoteNumber());
        Log.i(TAG, "test16_DeleteOddNumberNote: ending");
    }
    
    public void test17CancelDeleteMuti() {
        ...
        mSolo.clickOnView(findView(R.id.menu_all_select));
    ...
    public void test18ClickItemSelect() {
        Log.i(TAG, "test18_ClickItemSelect: begining");
        if (getCurrentNoteNumber() == 0) {
            Log.e(TAG, "There is no note in the list");
            addNote(1);
        }
        ...
        mSolo.assertCurrentActivity("Can not enter NoteDelete activity", NoteDelete.class);
        mSolo.sleep(mSleeptime);

        mSolo.clickInList(1);
        assertTrue(mSolo.isCheckBoxChecked(0));
        mSolo.sendKey(KeyEvent.KEYCODE_BACK);
        Log.i(TAG, "test18_ClickItemSelect: ending");
    } 
    ...
    public void test19MenuOfNoteDelete() {
        ...
        mSolo.clickOnView(findView(R.id.menu_no_select));
        assertTrue(mSolo.searchText("0"));

        mSolo.clickOnImage(0);
        Log.i(TAG, "test19_MenuOfNoteDelete: ending");
    }
    
    public void test20BackFromDelete() {
        Log.i(TAG, "test20_BackFromDelete: begining");
        if (getCurrentNoteNumber() == 0) {
            Log.e(TAG, "There is no note in the list");
            addNote(1);
        } 
        ...
        Log.i(TAG, "test20_BackFromDelete: ending");
    }
    
    public void test21DeleteAllNote() {
    ...
    public void test22DisableMenuWhenNoNote() {
        ...
        if (getCurrentNoteNumber() == 0) {
            ...
            if (Locale.getDefault().getLanguage().equals("en")) {
                assertTrue(mSolo.searchText("Delete note"));
            } else {
