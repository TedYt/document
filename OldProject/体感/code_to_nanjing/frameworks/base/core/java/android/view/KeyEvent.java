...
public class KeyEvent extends InputEvent implements Parcelable {
    ...
    */
    ...
    /** M:[SmartBook] Key code constant: tp key.
     * Starts the system smart tp wakeup. 
     * @hide
     */
    public static final int KEYCODE_KEYTP           = 238;

	public static final int KEYCODE_SENSOR_WAKE		= 239;

    private static final int LAST_KEYCODE           = KEYCODE_SENSOR_WAKE;
    ...
    private static void populateKeycodeSymbolicNames() {
		...
		names.append(KEYCODE_KEYTP, "KEYCODE_KEYTP");
		names.append(KEYCODE_SENSOR_WAKE, "KEYCODE_SENSOR_WAKE");
    };
