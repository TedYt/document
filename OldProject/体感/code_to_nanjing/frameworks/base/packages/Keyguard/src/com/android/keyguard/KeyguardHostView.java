...
public class KeyguardHostView extends KeyguardViewBase {
    ...
    protected void onAttachedToWindow() {
        ...
        // haoran.wang,SFAE-102,begin
        if (/*FeatureOption.TINNO_SLIPCOVER_MODE_SUPPORT || FeatureOption.TINNO_SMART_AWAKE_SUPPORT*/true) {
            Log.d("haoran", "onAttachedToWindow->registerReceiver:mSlipcoverReceiver");
            IntentFilter intentFilter = new IntentFilter("android.intent.action.HALL_CHANGED");
            mContext.registerReceiver(mSlipcoverReceiver, intentFilter);
            count_flag++;
        }
        // haoran.wang,SFAE-102,end
    }

    // haoran.wang,SFAE-102,begin
    private static int count_flag = 0;
    
    private BroadcastReceiver mSlipcoverReceiver = new BroadcastReceiver() {
    
        @Override
        public void onReceive(Context context, Intent intent) {
            Log.d("haoran", "mSlipcoverReceiver->onReceive");
            ...
            if (intent.getIntExtra("state", 0) == 1) {
                Log.d("haoran", "mSlipcoverReceiver->dismiss");
                ...
                try {
                    ...
                    Log.d("haoran", "can't dismiss keyguard on launch");
                }
            }
        }
    };
	...
	Log.d("aoran","keyguardHostView getSV securityViewIdForMode =" +securityViewIdForMode);
    ...
    private void showSecurityScreen(SecurityMode securityMode) {
        ...
        final int securityViewIdForMode = getSecurityViewIdForMode(securityMode);
	Log.d("aoran","keyguardHostView showSS securityViewIdForMode =" +securityViewIdForMode);
