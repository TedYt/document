    ...
    public void onCreate() {
        ...
        if (phone == null) {
            ...
            */
            ...
            /// M: aoran,for Tinno Gesture,Start @{
            ...
            intentFilter.addAction("android.intent.action.ACTION_PHONE_ANSWER");
            /// @} end modify
    ...
    */
    ...
    private class PhoneGlobalsBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            /// M: aoran,date20140303,for Tinno Gesture,Start @{
                ...
                PhoneLog.v(LOG_TAG, "==ACTION_PHONE_SPEAKER_ON==, phoneState:" + phoneState + " isHeadsetPlugged:" +
                        wiredHeadsetManager.isHeadsetPlugged() + " isBluetoothHeadsetAudioOn:" + bluetoothManager.isBluetoothHeadsetAudioOn());

                //baichangwei,date20140404,for SFAE-484 issue
                //bluetoothManager.isBluetoothHeadsetAudioOn()

                if (phoneState == PhoneConstants.State.OFFHOOK &&
                        !wiredHeadsetManager.isHeadsetPlugged() && !bluetoothManager.isBluetoothAvailable()) {
                    audioRouter.setSpeaker(speakerOn);
            ...
            } else if (action.equals("android.intent.action.ACTION_PHONE_ANSWER")) {  // --------------------
                try {
                    //getInCallScreenInstance().internalAnswerCallGesture();
                    PhoneUtils.internalAnswerCall();
                } catch (Exception e) {
                    Log.e(LOG_TAG, "internalAnswercall exception!");
                }
            }
            /// @} end modify			
        }
