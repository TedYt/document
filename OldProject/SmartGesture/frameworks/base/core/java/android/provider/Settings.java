...
public final class Settings {
    ...
    public static final class System extends NameValueTable {
        ...
        public static final String RINGTONE2 = "ringtone_sim2";//<TUI_SETTINGS>
        ...
        public static final Uri DEFAULT_RINGTONE_URI2 = getUriFor(RINGTONE2);//<TUI_SETTINGS>
       ...
       /**
         ...
         */
		 ...
		 /**
         * KEY_BRIGHTNESS value for key backlight brightness
         * @hide
         */
    ...
    public static final class Secure extends NameValueTable {
        ...
        public static int getIntForUser(ContentResolver cr, String name, int def, int userHandle) {
            ...
            try {
		        ...
		        /** @hide */
        public static int getInt(ContentResolver cr, String name2, String name, int def) {
            if(Global.getInt(cr,name2,def) == 0){
                return 0;
            }
            return getIntForUser(cr, name, def, UserHandle.myUserId());
        }
        ...
        /// M: yuanyuan.wang modify for Gesture Settings @{
	//B yutao 2014.6.19
        public static final String UPSET_SNOOZE_ALARM_ENABLED =
        		"upset_snooze_alarm_enabled";

        public static final String DOUBLECLICK_HOMEKEY_ENABLED=
        		"doubleclick_homekey_enabled";

        public static final String PROMIXY_POWERKEY_UNLOCK_ENABLED=
        		"promixy_powerkey_unlock_enabled";

        public static final String PROMIXY_SPEAKER_ENABLED =
        		"promixy_speaker_enabled";	
        		
       	public static final String DOUBLECLICK_SCREEN_ENABLED=
        		"doubleclick_screen_enabled";

		public static final String GESTURE_QUICK_CAMERA_ENABLED=
        		"gesture_quick_camera";
	//E yutao 2014.6.19

        public static final String PROMIXY_INCOMING_CALL_ENABLED =
        		"promixy_incoming_call_enabled";
        public static final String PROMIXY_UNLOCK_ENABLED =
        		"promixy_unlock_enabled";
        public static final String UPSET_SILENT_ENABLED =
        		"upset_silent_enabled";
        public static final String UPSET_SPEAKER_ENABLED =
        		"upset_speaker_enabled";
        public static final String PROMIXY_ANSWER_PHONE_ENABLED =
        		"promixy_answer_phone_enabled";
        public static final String PROMIXY_DIAL_PHONE_ENABLED =
        		"promixy_dial_phone_enabled";
        public static final String PROMIXY_CAMERA_SNAP_ENABLED =
        		"promixy_camera_snap_enabled";

        public static final String PROMIXY_PHOTO_VIEW_ENABLED =
        		"promixy_photo_view_enabled";
         public static final String GESTURE_BROWSER_SCREEN_ON =
        		"gesture_browser_screen_on";
        public static final String GESTURE_VIDEO_FACE_PLAY =
        		"gestrue_video_face_play";
        public static final String GESTURE_GALLERY_SWIPE =
        		"gesture_gallery_swipe";
        /// @} end modify
        //TINNO_ECONOMICMODE_SUPPORT
		public static final String BATTERY_LOWSWITCH = "battery_lowswitch";

		//JUNMING.LIANG 
		public static final String WALLPAPER_LOCK = "wallpaper_lock";
		public static final String FESTIVAL_WALLPAPER = "festival_wallpaper";
		public static final String USING_FESTIVAL_WALLPAPER = "using_festival_wallpaper";
    ...
    public static final class Global extends NameValueTable {
        ...
        /// M: yuanyuan.wang modify for Gesture Settings @{
        public static final String ENABLE_GESTURE_SETTINGS_ENABLED =
                "enable_gesture_settings_enabled";
        /// @} end modify
       ...
       */
       ...
       public static final String OVERLAY_DISPLAY_DEVICES = "overlay_display_devices";
        ...
        /**
         * The PREFERRED_NETWORK_MODE of user manually saved
         * @hide
         */
