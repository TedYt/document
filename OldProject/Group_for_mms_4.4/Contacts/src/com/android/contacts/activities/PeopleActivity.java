...
public class PeopleActivity extends ContactsActivity
    ...
    private static final int SUBACTIVITY_MULTI_PICK = 1007;//multi select
    private static final int SHAREACTIVITY_MULTI_PICK = 1008;//multi share
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        final MenuItem deleteMenu = menu.findItem(R.id.menu_multi_delete);
        final MenuItem shareMenu = menu.findItem(R.id.menu_multi_share);//Add multi share contacts
        ...
        if (isSearchMode) {
            ...
            shareMenu.setVisible(false);//Add multi share contacts
        } else {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
         ...
         case R.id.menu_multi_delete: {
                ...
                intent.putExtra(MultiSelectAdapter.INT_TYPE, MultiSelectAdapter.TYPE_CONTACT);
                startActivityForResult(intent, SUBACTIVITY_MULTI_PICK);
                return true;
            }
           case R.id.menu_multi_share: {
                ...
                startActivityForResult(intent, SHAREACTIVITY_MULTI_PICK);
                return true;
            }
        }
        return false;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        switch (requestCode) {
            ...
            case SUBACTIVITY_MULTI_PICK:
                if (resultCode == RESULT_OK) {
                    mAllFragment.onMultiPickerResult(data);
                }
                break;
            case SHAREACTIVITY_MULTI_PICK:
                if (resultCode == RESULT_OK) {
                    mAllFragment.onShareMultiPickerResult(data);
                }
                break;
