...
import com.android.contacts.group.ContactGroupMultiSelectListFragment;

public class ContactsGroupMultiSelectActivity extends ContactsActivity {
    ...
    private void configFragment() {
        android.util.Log.d("wwf","configFragment");
        mListFragment = ContactGroupMultiSelectListFragment.newInstance(getIntent());
