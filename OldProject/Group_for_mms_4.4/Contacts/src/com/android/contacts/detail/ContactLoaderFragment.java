...
public class ContactLoaderFragment extends Fragment implements FragmentKeyListener {
 ...
 /**
         ...
         * @return
         */
        protected  boolean isRingtoneExisted(Context ctx, Uri ringtoneUri) {
    ...
    private void doPickRingtone() {
        ...
        //  // Don`t allow the user to pick a silent ringtone
        intent.putExtra(RingtoneManager.EXTRA_RINGTONE_SHOW_SILENT, false);

        Uri ringtoneUri;
        if (mCustomRingtone != null) {
            ringtoneUri = Uri.parse(mCustomRingtone);
            if(!isRingtoneExisted(mContext,ringtoneUri)){
