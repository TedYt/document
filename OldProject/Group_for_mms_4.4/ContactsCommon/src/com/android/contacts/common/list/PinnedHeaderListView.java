...
public class PinnedHeaderListView extends AutoScrollListView
    ...
    // haoran.wang,BSNPK-38,begin
    public void setBladeView(BladeView mbView) {
        mBladeView = mbView;
    }
    // haoran.wang,BSNPK-38,end
    ...
    public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount,
        ...
        if (mAdapter != null) {
            ...
            // haoran.wang,BSNPK-38,begin
            if (mBladeView != null && view instanceof PinnedHeaderListView) {
                if (mAdapter != null && mAdapter instanceof DefaultContactListAdapter) {
                    if (((DefaultContactListAdapter)mAdapter).getIndexer() != null) {
                        int section = ((DefaultContactListAdapter)mAdapter).getSection();
                        int listSectiongLength = mBladeView.getListSectionLength();
                        
                        if (section >= listSectiongLength) {
                            ((DefaultContactListAdapter)mAdapter).setSection(0);
                            section = 0;
                        }
