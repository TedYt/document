...
public class LocalAccountType extends BaseAccountType {
    ...
    public LocalAccountType(Context context, String authenticatorPackageName) {
    ...
    public CharSequence getDisplayLabel(Context context) {
		return mContext.getString(R.string.local_contact_name);
    }

	public static boolean isLocalType(String accountType) {
        return LocalAccountType.ACCOUNT_TYPE.equals(accountType);
    }
