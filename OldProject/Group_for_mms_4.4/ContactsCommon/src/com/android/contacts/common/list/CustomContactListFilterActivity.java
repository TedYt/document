            ...
            for (AccountWithDataSet account : accountTypes.getAccounts(false)) {
                ...
                try {
                    ...
                    while (iterator.hasNext()) {
                       ...
                       //android.util.Log.d("wwf","ll:"+group.getTitle(context)+",is:"+group.getIsDeleted()); 
    ...
    protected static class GroupDelta extends ValuesDelta {
        ...
        public static GroupDelta fromSettings(ContentResolver resolver, String accountName,
            ...
            try {
               ...
               //Fix  can't sync contacat to the car Bluetooth when the local account group not checked
                    // ACCOUNT_TYPE = "LOCAL";
                     // ACCOUNT_NAME = "Local";
                    if(accountName.equals("Local")&&accountType.equals("LOCAL"))
        ...
        public boolean getIsDeleted() {
            return getAsInteger(Groups.DELETED,0) != 0;
        }
