...
class AccountTypeManagerImpl extends AccountTypeManager
    ...
    protected void loadAccountsInBackground() {
      ...
      // Tinno: Added Local Account type
            addAccountType(new LocalAccountType(mContext, null), accountTypesByTypeAndDataSet, accountTypesByType);
		...
		// Tinno: Added Local account
		AccountWithDataSet localAccountWithDataSet = new AccountWithDataSet(LocalAccountType.ACCOUNT_NAME, LocalAccountType.ACCOUNT_TYPE, null);
