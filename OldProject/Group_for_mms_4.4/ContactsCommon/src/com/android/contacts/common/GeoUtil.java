...
public class GeoUtil {
    ...
    public static String getGeocodedLocationFor(Context context,  String phoneNumber) {
        ...
        try {
            ...
            //ro.geocode.close.config:show geocode location
            return SystemProperties.getBoolean("ro.geocode.close.config", false)?null:geocoder.getDescriptionForNumber(structuredPhoneNumber, locale);
