...
public class ImportVCardActivity extends Activity {
    ...
    private class VCardScanThread extends Thread implements OnCancelListener, OnClickListener {
        ...
        // Fix SEFOFAE-490. Support import from external SD card.
        ...
        public VCardScanThread(File sdcardDirectory) {
            ...
            if (!externalSdCard.exists() || !externalSdCard.isDirectory()
                    || !externalSdCard.canRead()) {
                externalSdCard = null;
            }
        }
        ...
        public void run() {
            ...
            try {
                ...
                if (externalSdCard != null) {
                    getVCardFileRecursively(externalSdCard);
                }
